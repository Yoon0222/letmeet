    ...
    <KeyboardAvoidingView
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={{ gap: Spacing.one }}>
          <Text style={styles.duprLabel}>DUPR 레이팅</Text>
          {profile?.dupr_status === 'verified' ? (
            ...
            <Text style={styles.duprHint}>DUPR 계정을 연결하면 공식 레이팅이 인증 배지와 함께 표시돼요.</Text>
          )}
          <Button
            title={profile?.dupr_status === 'verified' ? 'DUPR 다시 연결' : 'DUPR 계정 연결'}
            variant="outline"
