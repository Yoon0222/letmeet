...
피클볼 커뮤니티 슈퍼앱의 핵심 결정·작업 기록. 최신 엔트리가 위로 온다.
...
- [ ] 노션 커넥터 연결 (Claude 설정 → Connectors) 후 WORKLOG 미러링 — 사용자
- [ ] 변경분 커밋 (카카오·빌드설정·홈·탭재편·클럽·QA/워크로그)
- [x] Supabase 프로젝트 연결 + 스키마 실행 (ref `pjfhxkvdjipvdmfsacie`)
- [x] MVP 커뮤니티 매칭 구현 및 웹에서 동작 확인

---

### 2026-07-01 — QA 에이전트 · 워크로그 스킬 · 노션 확인
